...
jQuery(document).ready(function ($) {
    ...
    $('.bookacalendar').each(function (index) {
        var $this_id = $(this).attr('id');
        var $this_host = $(this).data('host');
        var $this_categories = $(this).data('categories');
        jQuery('#' + $this_id).fullCalendar({
            header: {
                left: 'month,listWeek',
                center: 'title',
                right: 'prev,next'
            ...
            events: '//' + $this_host + '/api5/tours/calendar/?categories=' + $this_categories,
